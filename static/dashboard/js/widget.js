!(function () {
    ...
    function r(t) {
        ...
        var e = i.host;
        i.pathname;
        console.log("http:" === i.protocol && (e = e.replace(/:80$/, "")), "https:" === i.protocol && (e = e.replace(/:443$/, "")), { host: e, pathname: ("/" === i.pathname[0] ? "" : "/") + i.pathname, href: i.href })
        return "http:" === i.protocol && (e = e.replace(/:80$/, "")), "https:" === i.protocol && (e = e.replace(/:443$/, "")), { host: e, pathname: ("/" === i.pathname[0] ? "" : "/") + i.pathname, href: i.href };
    }
    var n,
        o,
        a = {
            events: { width: 510, height: 600, isTransparent: !1, hideImportanceIndicator: !1, autosize: !1 },
            hotlists: { width: 400, height: 600, isTransparent: !1, dateRange: "12m" },
            screener: { width: 1100, height: 512, defaultColumn: "overview", defaultScreen: "general", market: "forex", showToolbar: !0, isTransparent: !1 },
            tickers: { isTransparent: !1 },
            financials: { width: 480, height: 830, autosize: !1, symbol: "NASDAQ:AAPL", isTransparent: !1, displayMode: "regular", largeChartUrl: "" },
            "crypto-mkt-screener": { width: 1e3, height: 490, defaultColumn: "overview", market: "crypto", screener_type: "crypto_mkt", displayCurrency: "USD", isTransparent: !1 },
            "forex-cross-rates": { width: 770, height: 400, isTransparent: !1, currencies: ["EUR", "USD", "JPY", "GBP", "CHF", "AUD", "CAD", "NZD", "CNY"], frameElementId: null, autosize: !1 },
            "forex-heat-map": { width: 770, height: 400, isTransparent: !1, currencies: ["EUR", "USD", "JPY", "GBP", "CHF", "AUD", "CAD", "NZD", "CNY"], frameElementId: null, autosize: !1 },
            "market-overview": { width: 400, height: 650, isTransparent: !1, dateRange: "12m" },
            "market-quotes": { width: 770, height: 450, isTransparent: !1 },
            "mini-symbol-overview": { width: 350, height: 220, symbol: "FX:EURUSD", dateRange: "12m", trendLineColor: "#37a6ef", underLineColor: "#e3f2fd", isTransparent: !1, autosize: !1, largeChartUrl: "" },
            "single-quote": { width: 350, symbol: "FX:EURUSD", isTransparent: !1 },
            "symbol-profile": { width: 480, height: 650, symbol: "NASDAQ:AAPL", isTransparent: !1 },
            "symbol-info": { width: 1e3, symbol: "NASDAQ:AAPL", isTransparent: !1 },
            "technical-analysis": { interval: "1m", width: 425, isTransparent: !1, height: 450, symbol: "NASDAQ:AAPL", showIntervalTabs: !0 },
            "ticker-tape": { isTransparent: !1, displayMode: "adaptive" },
        };
    !(function (t) {
        !(function (t) {
    ...
    (h.widgetId.get = function () {
        ...
        (c.prototype._getScriptsInfo = function () {
            var t = (function () {
                ...
                for (var t = document.getElementsByTagName("script"), e = 0; e < t.length; e++) if ("interactive" === t[e].readyState) return t[e].src;
                try {
                    throw new Error();
                } catch (r) {
            ...
            var h,
                l =
                    (void 0 === (h = i) && (h = location.host),
                    -1 !== ["i18n.tradingview.com", "partial.tradingview.com", "www.tradingview.com", "wwwcn.tradingview.com"].indexOf(h) ||
                    -1 !== ["d33t3vvu2t2yu5.cloudfront.net", "dwq4do82y8xi7.cloudfront.net", "s.tradingview.com", "s3.tradingview.com"].indexOf(h) ||
            ...
            return a.map(function (t) {
                return { scriptHost: i, scriptEnv: l, scriptElement: t };
            });
        }),
        (c.prototype._replaceScript = function (t) {
            ...
            (this.hasCopyright = c || h),
                ...
                (s && this._isValidSettings()) || (console.error("Invalid settings provided, fall back to defaults"), (this.settings = this.filterRawSettings(this.defaultSettings)));
            var l,
            ...
            this.script.parentNode && g ? (this.iframeContainer = this.script.parentNode) : (this.iframeContainer = document.createElement("div")),
                (this.iframeContainer.style.width = p),
                (this.iframeContainer.style.height = d),
            ...
            if (
                (f
                    ? (this.script.parentNode.replaceChild(this.iframe, f), this.script.parentNode.removeChild(this.script))
                    : g
                    ? (this.iframeContainer.appendChild(this.iframe), this.script.parentNode.removeChild(this.script))
                    : (this.iframeContainer.appendChild(this.iframe), this.script.parentNode.replaceChild(this.iframeContainer, this.script)),
                (function (t, e, i) {
                    ...
                    t.width && ((i.iframe.style.width = t.width + "px"), (i.iframeContainer.style.width = t.width + "px")),
                        (i.iframe.style.height = t.height + "px"),
                        (i.iframeContainer.style.height = t.height + (i.hasCopyright ? 32 : 0) + "px");
                }),
                u)
            ) {
        ...
        (c.prototype._iframeSrcBase = function (t, e) {
            ...
            var result = (
                "local" === e ? (i = "http://" + t) : "staging" === e && (i = -1 !== t.indexOf("beta.tradingview.com") ? "https://betacdn.tradingview.com" : "https://" + t),
            ...
            console.log(result)
            return "https://s.tradingview.com/embed-widget/tickers/";
        }),
        ...
        (c.prototype._buildGetQueryString = function () {
            ...
            return 0 === t.length
                ...
                : "?" +
                      (function (t) {
                          var e = [];
                          for (var i in t) t.hasOwnProperty(i) && null != t[i] && e.push({ key: i, pair: encodeURIComponent(i) + "=" + encodeURIComponent(t[i]) });
                          return e
                              .sort(function (t, e) {
    ...
    new ((function (t) {
        ...
        var i = { widgetId: { configurable: !0 }, propertiesToWorkWith: { configurable: !0 } };
        return (
            (i.widgetId.get = function () {
                return "tickers";
            }),
            (i.propertiesToWorkWith.get = function () {
                return ["symbols", "linkPageTemplate", "largeChartUrl", "timeframe", "locale", "whitelabel", "customer", "colorTheme", "isTransparent"];
            }),
